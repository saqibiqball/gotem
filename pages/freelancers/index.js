							...
							<MWT_Container className="px-0">
								...
								{!fetch && sources && (
									<>
										...
										<SourcesList users={sources.rows} publicPage={true} />
									</>
								)}
...
Freelancers.Layout = PagesLayout;

export async function getServerSideProps() {
	const sourcesData = await getSources({page: 1, limit: 10})
	return {
		props: {
			sourcesData
		},
